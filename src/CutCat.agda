...
-- The CutCat: free thin category on ℕ with Hom(m,n) ≡ (m ≤ n)
...
-- All coherence proofs are by reflexivity since ≤-trans with refl computes definitionally
